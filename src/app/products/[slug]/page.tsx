...
function SupplierCard({ supplier }: { supplier: any }) {
  ...
  return (
    <div className="bg-white border-2 border-gray-200 hover:border-orange-400 rounded-xl p-6 transition-all hover:shadow-lg">
      ...
      <Link
        href={`/supplier-match?product=${supplier.name}`}
        className="block text-center bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 rounded-lg transition-colors"
      >
        Request Quote
      </Link>
    </div>
